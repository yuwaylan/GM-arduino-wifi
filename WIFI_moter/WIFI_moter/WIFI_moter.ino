...
#define Bstart 3//bird start 接電阻接地
#define Bok 12//bird ok 接裝置的接電阻接地

#define wifiStB A0//wifi tell bird start 不用接
#define wifiOkB A1//tell wifi bird ok 接電阻接地

#define Lstart 9//listen start 接電阻接地
#define Lok 10//listen ok 接裝置的接電阻接地

#define wifiStL A2//wifi tell listen start 不用接
#define wifiOkL A3//tell wifi listen ok 接電阻接地

#define LEDsendB 7//led bird send
#define LEDrecB 8//led bird rec

#define LEDsendL 5//led listen send
